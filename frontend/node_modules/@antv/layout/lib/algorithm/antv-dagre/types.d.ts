...
type DagreRankdir = 'TB' | 'BT' | 'LR' | 'RL' | 'tb' | 'lr' | 'rl' | 'bt';
 ...
 */
interface AntVDagreLayoutOptions extends BaseLayoutOptions {
    /**
...
export type { AntVDagreLayoutOptions, DagreAlign, DagreRankdir };
