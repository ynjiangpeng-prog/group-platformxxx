    ...
    class AdaptLayout extends BaseLayout {
        ...
        execute(model, options) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.instance.execute(this.graphData2LayoutModel(model), this.transformOptions(deepMix({}, this.options, options)));
        ...
        transformOptions(options) {
            ...
            const defaultNode = (datum) => {
                ...
                const id = idOf(datum);
                return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ id }, (isNumber(style === null || style === void 0 ? void 0 : style.x) ? { x: style.x } : {})), (isNumber(style === null || style === void 0 ? void 0 : style.y) ? { y: style.y } : {})), (isNumber(style === null || style === void 0 ? void 0 : style.z) ? { z: style.z } : {})), { parentId }), (isCombo(id) ? { isCombo: true } : {}));
            };
            const defaultEdge = (datum) => ({ id: idOf(datum), source: datum.source, target: datum.target });
 ...
 */
export function isLegacyAntVLayout(Ctor) {
 ...
 * @returns <zh/> G6 布局类 | <en/> G6 layout class
 */
export function legacyLayoutAdapter(Ctor, context) {
    class AdaptLayout extends BaseLayout {
        constructor(context, options) {
            super(context, options);
            this.instance = new Ctor({});
