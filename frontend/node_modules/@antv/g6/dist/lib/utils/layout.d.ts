...
import type { AntVGraphData, AntVLayout, LegacyAntVLayout } from '../layouts/types';
 ...
 */
export declare function layoutMapping2GraphData(layoutMapping: AntVGraphData): GraphData;
/**
 ...
 */
export declare function isLegacyAntVLayout(Ctor: new (options: Record<string, unknown>) => unknown): Ctor is new (options: Record<string, unknown>) => LegacyAntVLayout;
/**
 * <zh/> 将 @antv/layout 布局适配为 G6 布局
 *
 * <en/> Adapt @antv/layout layout to G6 layout
 ...
 * @returns <zh/> G6 布局类 | <en/> G6 layout class
 */
export declare function legacyLayoutAdapter(Ctor: new (options: Record<string, unknown>) => LegacyAntVLayout, context: RuntimeContext): new (context: RuntimeContext, options?: Record<string, unknown>) => BaseLayout;
/**
 * <zh/> 调用布局成员方法
 *
