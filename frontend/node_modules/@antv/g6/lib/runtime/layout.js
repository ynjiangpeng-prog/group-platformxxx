...
class LayoutController {
            ...
            if ((0, layout_1.isLayoutWithIterations)(layout)) {
                ...
                if (animation) {
                    return yield layout.execute(data, {
                        ...
                        onTick: (tickData) => this.updateElementPosition(tickData, false),
                    });
                }
    ...
    initGraphLayout(options) {
        ...
        const { type, animation, iterations } = options, restOptions = __rest(options, ["type", "animation", "iterations"]);
        ...
        const STDCtor = Object.getPrototypeOf(Ctor.prototype) === layouts_1.BaseLayout.prototype
            ? Ctor
            : (0, layout_2.isLegacyAntVLayout)(Ctor)
                ? (0, layout_2.legacyLayoutAdapter)(Ctor, this.context)
