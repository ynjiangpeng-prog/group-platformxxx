...
exports.isLegacyAntVLayout = isLegacyAntVLayout;
exports.legacyLayoutAdapter = legacyLayoutAdapter;
    ...
    class AdaptLayout extends base_layout_1.BaseLayout {
        ...
        execute(model, options) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.instance.execute(this.graphData2LayoutModel(model), this.transformOptions((0, util_1.deepMix)({}, this.options, options)));
        ...
        transformOptions(options) {
            const isCombo = (id) => context.model.isCombo(id);
            const defaultNode = (datum) => {
                var _a;
                const { style } = datum || {};
                const parentId = 'combo' in (datum || {}) ? ((_a = datum.combo) !== null && _a !== void 0 ? _a : null) : null;
                const id = (0, id_1.idOf)(datum);
                return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ id }, ((0, util_1.isNumber)(style === null || style === void 0 ? void 0 : style.x) ? { x: style.x } : {})), ((0, util_1.isNumber)(style === null || style === void 0 ? void 0 : style.y) ? { y: style.y } : {})), ((0, util_1.isNumber)(style === null || style === void 0 ? void 0 : style.z) ? { z: style.z } : {})), { parentId }), (isCombo(id) ? { isCombo: true } : {}));
            };
            const defaultEdge = (datum) => ({ id: (0, id_1.idOf)(datum), source: datum.source, target: datum.target });
            options.node = defaultNode;
            options.edge = defaultEdge;
            if (!('onTick' in options))
                return options;
            const onTick = options.onTick;
            options.onTick = (layout) => onTick(this.getLayoutResult(layout));
            return options;
        }
        getLayoutResult(layout) {
            ...
            layout.forEachNode((node) => {
                ...
                const style = Object.assign({ x: node.x, y: node.y, z: (_a = node.z) !== null && _a !== void 0 ? _a : 0 }, (node.size ? { size: node.size } : {}));
                target === null || target === void 0 ? void 0 : target.push({ id: nodeId, style });
            });
 ...
 */
function isLegacyAntVLayout(Ctor) {
 ...
 * @returns <zh/> G6 布局类 | <en/> G6 layout class
 */
function legacyLayoutAdapter(Ctor, context) {
    class AdaptLayout extends base_layout_1.BaseLayout {
        constructor(context, options) {
            super(context, options);
            this.instance = new Ctor({});
            ...
            if ('stop' in this.instance && 'tick' in this.instance) {
                ...
                this.tick = (iterations) => {
                    var _a;
                    const tickResult = (_a = instance.tick) === null || _a === void 0 ? void 0 : _a.call(instance, iterations);
        ...
        graphData2LayoutModel(data) {
            ...
            const combosToLayout = combos.map((combo) => {
                return {
                    ...
                    data: Object.assign({ _isCombo: true }, combo.data),
