 ...
 */
function padVectors(a, b) {
    if (a.length == b.length) {
        return [a, b];
    }
    else {
        if (((0, is_1.isVector3)(a) && a[2] !== 0) || ((0, is_1.isVector3)(b) && b[2] !== 0)) {
            throw new Error((0, print_1.format)('Vectors could not operate due to different dimensions.'));
        }
...
function divide(a, b) {
    ...
    return a.map((v, i) => {
        if (b[i] == 0) {
            throw new Error((0, print_1.format)('Vector could not be divided by zero'));
        }
        return v / b[i];
    });
}
